    ...
    <>
      ...
      <div className='bg-purple-500 flex flex-wrap justify-center items-center gap-4 py-10'>
        <div
          ...
          style={{ backgroundImage: `url('../../../public/assets/PLAYGROUP.png')`, backgroundSize: 'cover' }}
          onMouseEnter={e => (e.currentTarget.style.backgroundImage = `url('../../../public/assets/PLAYGROUP.jpg')`)}
          onMouseLeave={e => (e.currentTarget.style.backgroundImage = `url('../../../public/assets/PLAYGROUP.png')`)}
        ></div>
