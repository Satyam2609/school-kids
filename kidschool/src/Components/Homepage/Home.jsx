...
function Home() {
  ...
  return (
    <>
      ...
      <div className='bg-purple-500 py-10 overflow-x-auto'>
  <div className='flex flex-nowrap gap-4 px-4'>
    <div
      className='flex-shrink-0 h-48 w-48 sm:h-64 sm:w-64 md:h-80 md:w-80 border-2 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300'
